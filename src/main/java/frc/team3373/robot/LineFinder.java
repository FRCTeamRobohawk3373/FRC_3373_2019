    ...
    public boolean lineUpdate() {
        ...
        case SEARCH_LEFT:
            if (!left.get() && !right.get() && step == 1) {
                ...
                SmartDashboard.putString("Command", "(If swerve not moving) Move forward 10 inches, move right 2 in"); // TODO:
                                                                                                                       // measure
                missed = true;
                step = 5;
        ...
        case SEARCH_RIGHT:
            if (!left.get() && !right.get() && step == 1) {
                ...
                SmartDashboard.putString("Command", "(If swerve not moving) Move forward 10 inches, move left 2 in"); // TODO:
                                                                                                                      // measure
                missed = true;
                step = 5;
